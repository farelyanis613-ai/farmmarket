...
<div class="page-content pb-16">
    ...
    <div class="page-header">
        ...
        <!-- products/list.php: removed inline <style> block; styles consolidated into public/css/style.css -->
            </select>
        </div>
    </div>
                    ...
                    <div class="fm-product-body">
                        ...
                        <div class="fm-product-foot">
                            ...
                            <div class="fm-product-actions">
                                <a href="index.php?action=product&id=<?= $product['id'] ?>" class="btn-secondary">
                                    Détails
                                </a>
                                <!-- Inline styles moved to public/css/style.css -->
                                <!-- products/list.php: removed inline <style> block; styles consolidated into public/css/style.css -->
