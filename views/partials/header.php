...
<head>
    ...
    <!-- Tailwind compilé, servi via jsDelivr (remplace l'ancien Play CDN cdn.tailwindcss.com) -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/farelyanis613-ai/farmmarket@main/public/css/tailwind.min.css">
